                    ...
                    <div class="rooms-content layout-grid style-01">
                        <div class="row">
                            <div class="room col-sm-4 clearfix">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="#"><img src="images/gallery/img-4.jpg" alt=""></a>
                                    </div>
                            ...
                            <div class="room col-sm-4 clearfix">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="#"><img src="images/gallery/img-11.jpg" alt=""></a>
                                    </div>
                                    <div class="room-summary">
                                        <h3 class="room-title">
                            ...
                            <div class="room col-sm-4 clearfix">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="#"><img src="images/gallery/img-6.jpg" alt=""></a>
                                    </div>
                                    <div class="room-summary">
                                        <h3 class="room-title">
                            ...
                            <div class="room col-sm-4 clearfix">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="#"><img src="images/gallery/img-10.jpg" alt=""></a>
                                    </div>
                                    <div class="room-summary">
                                        <h3 class="room-title">
                                            <a href="#">Flex Room</a>
                            ...
                            <div class="room col-sm-4 clearfix">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="#"><img src="images/gallery/img-9.jpg" alt=""></a>
                                    </div>
                                    <div class="room-summary">
                                        <h3 class="room-title">
                            ...
                            <div class="room col-sm-4 clearfix">
                                <div class="room-item">
                                    <div class="room-media">
                                        <a href="#"><img src="images/gallery/img-8.jpg" alt=""></a>
                                    </div>
                                    <div class="room-summary">
                                        <h3 class="room-title">
                                            <a href="#">Luxury Room</a>
                                        </h3>
                                        <div class="room-price">From: <span class="price">$150.0</span></div>
                                        <p class="room-description">Lorem ipsum dolor sit amet, consecte adipiscing elit, sed diam nonummy wisi enim ad minim vel eum iriure</p>
                                        <div class="room-meta clearfix">
                                            <a href="blog-single.html" class="btn-icon">Read more</a>
                                        </div>

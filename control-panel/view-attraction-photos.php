                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    if (count($ATTRACTION_PHOTO) > 0) {
                                        foreach ($ATTRACTION_PHOTO as $key => $attraction_photo) {
                                            ?>
                                            <div class="col-md-3" id="div<?php echo $attraction_photo['id']; ?>">
                                                ...
                                                <div class="img-caption">
                                                    ...
                                                    <div class="d">
                                                        ...
                                                        <a href="edit-attraction-photo.php?id=<?php echo $attraction_photo['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a>
                                                        <a href="arrange-attraction-photos.php?id=<?php echo $id; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php

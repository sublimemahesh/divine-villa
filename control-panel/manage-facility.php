                                ...
                                <div>
                                        ...
                                        if (count($FACILITY) > 0) {
                                            foreach ($FACILITY as $key => $facility) {
                                                ?>
                                                <div class="col-md-3"  id="div<?php echo $facility['id']; ?>">
                                                    <div class="photo-img-container">
                                                        <img src="../upload/facility/<?php echo $facility['image_name']; ?>" class="img-responsive ">
                                                    </div>
                                                    <div class="img-caption">
                                                        <p class="maxlinetitle"><?php echo $facility['title']; ?></p>
                                                        <div class="d">
                                            ...
                                            ?> 
                                            <b style="padding-left: 15px;">No Facility in the database.</b> 
                                        <?php } ?> 

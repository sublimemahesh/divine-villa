$(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        if (!$('#title').val() || $('#title').val().length === 0) {
            ...
            $.ajax({
                url: "post-and-get/villa-equipment.php",
                type: "POST",
                data: formData,
                async: false,
                dataType: 'json',
                success: function (result) {
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("create-villa-equipment.php?id=" + result.id);
                        }, 1500);
                    });
                },
                cache: false,
            ...
            $.ajax({
                ...
                success: function (result) {
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("edit-villa-equipment.php?id=" + result.id);
                        }, 1500);
                    });
                },
                cache: false,
